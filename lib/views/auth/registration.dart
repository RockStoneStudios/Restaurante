...
import 'package:vendors/controllers/registration_controller.dart';
import 'package:vendors/models/registration_model.dart';
      ...
      appBar: AppBar(
        ...
        title: Container(
          ...
          child: const Text(
            "SopeFoods",
            style: TextStyle(
                fontSize: 22, color: kPrimary, fontWeight: FontWeight.w700),
          ),
        ),
      ),
      body: ListView(
